 ...
 */
public class Home2Fragment2 extends Fragment implements View.OnClickListener {
    ...
    LinearLayout linear_home_cat,linear_home;
    Button btn_dog, btn_cat;

    ListView list_best, list_dc,list_best_cat, list_dc_cat;
    ArrayList<BestGoodInfo> bestItemList;
    ArrayList<BestGoodInfo> dcItemList;
    ArrayList<BestGoodInfo> bestItemList_cat;
    ArrayList<BestGoodInfo> dcItemList_cat;

    GoodsListAdapter bestListAdapter;
    GoodsListAdapter dcListAdapter;
    GoodsListAdapter bestListAdapter_cat;
    GoodsListAdapter dcListAdapter_cat;
    ...
    String params_1,params_2,params_3,params_4,params_5;
    ...
    public static Home2Fragment2 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("Home2Fragment2", "-------------------------Home2Fragment2");
        ...
        list_best_cat = (ListView)v.findViewById(R.id.list_home_best_cat);
        list_dc_cat = (ListView)v.findViewById(R.id.list_home_dc_cat);
        ...
        linear_home = (LinearLayout)v.findViewById(R.id.linear_home_dog);
        linear_home_cat = (LinearLayout)v.findViewById(R.id.linear_home_cat);

        Log.e("Home2Fragment2","%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%onStart");
        /** 시작한다 시작해 ! **/
        params_1 = "?mdesign_no=1";
        params_2 = "?mdesign_no=14";

        params_4 = "?mdesign_no=2";
        params_5 = "?mdesign_no=15";
        ...
        bestItemList = goods_list(params_4);
        bestListAdapter = new GoodsListAdapter(getContext(), bestItemList);
        list_best_cat.setAdapter(bestListAdapter);
        Utility.setListViewHeightBasedOnChildren(list_best_cat);

        bestItemList = goods_list(params_5);
        bestListAdapter = new GoodsListAdapter(getContext(), bestItemList);
        list_dc_cat.setAdapter(bestListAdapter);
        Utility.setListViewHeightBasedOnChildren(list_dc_cat);
        /** 혼란하다 혼란해! **/
    ...
    public void onClick(View v) {
        ...
        switch(id){
            case R.id.btn_slide_dog:
                ...
                linear_home_cat.setVisibility(View.GONE);
            ...
            case R.id.btn_slide_cat:
                ...
                linear_home_cat.setVisibility(View.VISIBLE);
