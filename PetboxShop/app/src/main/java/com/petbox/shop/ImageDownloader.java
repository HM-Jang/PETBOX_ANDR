...
public class ImageDownloader
{
    ...
    static Bitmap Down_bitmap = null;
    ...
    public static void download(String url, ImageView imageView)
    {
        ...
        else if(cancelPotentialDownload(url, imageView))
        {
            ...
            Log.e("ImageDownloader", "download(String url, ImageView imageView");
    ...
    public static class saveBitmapToFile extends AsyncTask<String, Void, Bitmap>
    {
        ...
        protected Bitmap doInBackground(String... strs) {
            Log.e("Start download bitmap", "들어오긴 함");
            Log.e("Start download bitmap", "비트맵을 다운로드 해서 return 합니다.");
            bitmap = downloadBitmap(strs);
            Down_bitmap = bitmap;
            return bitmap;
        }
    ...
    public static void SaveBitmapToFileCache(String url_power, String filename)
    {
        Log.e("SaveBitmapToFileCache",url_power + filename);
        ...
        Log.e("SaveBitmapToFileCache", "생성 다함");
        new saveBitmapToFile().execute(url_power);

/*
        try {
            Log.e("SaveBitmapToFileCache","씨발");

            new saveBitmapToFile().execute(url_power).get();
            //execute.get 으로 해당 값ㅇ르 불러오지 못함.

            Log.e("SaveBitmapToFileCache","개새꺄");

        } catch (InterruptedException e) {
            Log.e("SaveBitmapToFileCache","InterruptedException");
            e.printStackTrace();
        } catch (ExecutionException e) {
            Log.e("SaveBitmapToFileCache","ExecutionException");
            e.printStackTrace();
        }
*/
        Log.e("SaveBitmapToFileCache","제기랄");
        BitmapFactory.Options bmOptions;
        Log.e("SaveBitmapToFileCache","뭐가");
        bmOptions = new BitmapFactory.Options();
        Log.e("SaveBitmapToFileCache","문제여");
        ...
        try {
           ...
           Down_bitmap.compress(Bitmap.CompressFormat.JPEG, 100, out);
